...
//    }
//    
//    func collectInput(_ touches: [Touch]) {
...
//        
//        // 1. input collection
//        print(pendingInput.count)
//        for touches in pendingInput {
//            // 2. intent resolution
...
//            switch intent {
//            case .transform:
//                // use a transform system to update the transform
//                transformSystem.update(ctx: &sceneContext, input: touches)
//            case .unknown: break
//            }
//        }
